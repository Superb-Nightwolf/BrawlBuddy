    ...
    for item in payload.get("brawlers", []):
        ...
        brawlers.append(
            PlayerBrawler(
                ...
                next_milestone_label=prestige.next_milestone_label,
                trophies_to_next_milestone=prestige.trophies_to_next_milestone,
                trophies_to_prestige=prestige.trophies_to_prestige,
